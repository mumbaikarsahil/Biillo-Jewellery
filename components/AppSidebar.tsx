...
const operationModules = [
  ...
  { href: '/job-bags', label: 'Fabrication', icon: Briefcase },
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col md:flex-row">
      ...
      <aside className="hidden md:flex flex-col w-[240px] h-screen fixed left-0 top-0 border-r border-border bg-card z-50 shadow-sm overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-3 py-5 space-y-6 custom-scrollbar">
           ...
           <div className="space-y-1">
             <p className="px-3 text-[9px] font-black uppercase tracking-widest text-muted-foreground/50 mb-2">Core Modules</p>
      ...
      <main className="flex-1 flex flex-col min-h-screen 
        pt-12 pb-14        /* Mobile Padding to clear tight header/footer */
        md:pt-0 md:pb-0    /* Desktop Padding reset (pages handle their own padding) */
        md:ml-[240px]      /* Push content right exactly the width of sidebar */
      ">
        {children}
      </main>
